...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\AdministradorOperadorMiddleware::class,
        \App\Http\Middleware\ProfessorMiddleware::class,
        \App\Http\Middleware\AlunoMiddleware::class,
    ];
    ...
    protected $routeMiddleware = [
        ...
        //'auth' => \Illuminate\Auth\Middleware\Authorize::class,
        ...
        'administradoroperador' => \App\Http\Middleware\AdministradorOperadorMiddleware::class, 
